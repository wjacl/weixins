...
<div class="page">
    <div class="page__hd" style="margin-top:5px">
         <h2 style="text-align:center;vertical-align: middle;">${fi.name }</h2>
    </div>
    <div class="page__bd">
                    ...
                    <div class="weui-uploader">
                        ...
                        <div class="weui-uploader__bd">
                            ...
                            <c:forTokens items="${fi.certificates }" var="it" delims=";">
                                <li class="weui-uploader__file" style="background-image:url(${ctx}/admin/fuser/getImg/${it })" data-id="${it }"></li>
                            </c:forTokens>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="weui-cell__bd">
                    <div class="weui-uploader">
                        <div class="weui-uploader__hd">                  	
                            ...
                            <div class="weui-uploader__info"><span id="brandUploadCount"></span></div>
                        </div>
                        <div class="weui-uploader__bd">
...
<script>
	...
	$(function(){
		...
		if('${fi.brandType}' == '1'){
			var brandUploader = new ImgUploader('brandUploader','',false,-1,2,'brandUploadCount','brandUploaderFiles');
		}
	})
