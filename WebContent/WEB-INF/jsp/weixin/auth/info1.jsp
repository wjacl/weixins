...
<div class="page">
    <div class="page__hd" style="margin-top:5px">
         <h2 style="text-align:center;vertical-align: middle;">认证-厂家基本信息填写</h2>
    </div>	
	<!-- 工厂信息填写  -->
    <div class="page__bd">
		...
		<div class="weui-cells weui-cells_form" style="margin-top:5px">    	
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" name="dname" pattern=".{1,30}" placeholder="请输入厂名"/>
                </div>
            </div>
            <div class="weui-cell">
            ...
            <div class="weui-cell">
                <div class="weui-cell__hd"><label for="" class="weui-label">厂址：</label></div>
                <div class="weui-cell__bd">
