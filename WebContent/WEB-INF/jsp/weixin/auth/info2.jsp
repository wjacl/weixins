...
<div class="page">
    <div class="page__hd" style="margin-top:5px">
         <h2 style="text-align:center;vertical-align: middle;">认证-商家基本信息填写</h2>
    </div>	
	<!-- 商家信息填写  -->
    <div class="page__bd">
		...
		<div class="weui-cells weui-cells_form" style="margin-top:5px">    	
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" name="dname" pattern=".{1,30}" placeholder="请输入店名"/>
                </div>
            </div>
            <div class="weui-cell">
                <div class="weui-cell__hd"><label class="weui-label">法人姓名：</label></div>
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" name="idcard" required maxlength="30" placeholder="请输入法人姓名" emptyTips="请输入法人姓名" notMatchTips="法人姓名长度不能超过30个字符">
                </div>
            ...
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" name="idcard" required pattern="REG_IDNUM" maxlength="18" placeholder="请输入你的身份证号码" emptyTips="请输入身份证号码" notMatchTips="请输入正确的身份证号码">
                </div>
                <div class="weui-cell__ft">
                    <i class="weui-icon-warn"></i>
                </div>
            ...
            <div class="weui-cell">
                <div class="weui-cell__hd"><label for="" class="weui-label">店址：</label></div>
                <div class="weui-cell__bd">
                    <input class="weui-input" name="location" type="text" value=""/>
                </div>
                <div class="weui-cell__ft">
                    <button class="weui-vcode-btn" id="location-btn">获取位置</button>
                </div>
            </div>
