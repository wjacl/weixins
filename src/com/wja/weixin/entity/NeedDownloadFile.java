...
public class NeedDownloadFile
{
    public static enum Type
    {
        ...
        AUTH_CRIED("auth", false), AUTH_LOGO("logo", false), BRAND_AUTHOR("auth/brand_author", false), BRAND_LOGO(
            "brandLogo", false), MESSAGE_IMG("message_img", true), PRODUCT_IMG("product_img", true), WORK_ORDER_IMG(
                "work_order_img", true), MESSAGE_VOICE("voices", true), WORK_ORDER_VOICE("voices", true);
