...
public class Hello extends HttpServlet
{
    ...
    private void sendMsg()
    {
        ...
        /*
         * List<String> userList = userManager.subscriberList(); if (userList.size() > 0) { String toUserOpenId =
         * userList.get(0).toString(); String content = "主动发送"; CustomerMsg customerMsg = new CustomerMsg(toUserOpenId);
